...
/// Extension trait for an Ethernet packet.
pub trait EthernetPacketProcessing
{
	/// Process assuming the poll mode driver has hardware offloading for IEEE 802.1Q and IEEE 802.1ad QinQ Virtual LANs.
	#[inline(always)]
	fn process_poll_mode_driver_offloads_qinq_vlan_tagging_stripping(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
	...
	#[inline(always)]
	fn process_poll_mode_driver_offloads_only_vlan_tagging_stripping(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
	
	/// Process assuming the poll mode driver has no hardware offloading for IEEE 802.1Q and IEEE 802.1ad QinQ Virtual LANs.
	#[inline(always)]
	fn poll_mode_driver_does_not_offload_any_vlan_stripping(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
	
	#[doc(hidden)]
	#[inline(always)]
	fn process(&mut self, packet: impl Packet, packet_processing: &PacketProcessing<impl PacketProcessingDropObserver>, layer_3_length: u16, potentially_invalid_ether_type: EtherType);
	
	#[doc(hidden)]
	#[inline(always)]
	fn process_layer_3(layer_3_packet: &mut Layer3Packet, packet: impl Packet, packet_processing: &PacketProcessing<impl PacketProcessingDropObserver>, layer_3_length: u16, potentially_invalid_ether_type: EtherType);
	
	#[doc(hidden)]
	#[inline(always)]
	fn process_internet_protocol_version_4(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
	
	#[doc(hidden)]
	#[inline(always)]
	fn process_internet_protocol_version_6(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
	
	#[doc(hidden)]
	#[inline(always)]
	fn process_address_resolution_protocol(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>);
...
impl EthernetPacketProcessing for EthernetPacket
{
	#[inline(always)]
	fn process_poll_mode_driver_offloads_qinq_vlan_tagging_stripping(&mut self, packet: impl Packet, packet_processing_by_virtual_lan: &PacketProcessingByVirtualLan<impl PacketProcessingDropObserver>)
	{
