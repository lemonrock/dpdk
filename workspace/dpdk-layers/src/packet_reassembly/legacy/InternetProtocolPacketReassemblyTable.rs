...
impl InternetProtocolPacketReassemblyTable
{
	...
	#[inline(always)]
	pub fn reassemble_fragmented_internet_protocol_version_4_packet(&mut self, incoming_packet: impl Packet, incoming_packet_arrival_timestamp: Cycles, incoming_packet_internet_protocol_version_4_packet_header: &mut InternetProtocolVersion4PacketHeader) -> Option<PacketBuffer>
	{
	...
	/// Use `Cycles::current_rdtsc_cycles_since_boot()` or a cached value.
	#[inline(always)]
	pub fn reassemble_fragmented_internet_protocol_version_6_packet(&mut self, incoming_packet: impl Packet, incoming_packet_arrival_timestamp: Cycles, incoming_packet_internet_protocol_version_6_packet_header: &mut InternetProtocolVersion6PacketHeader) -> Option<PacketBuffer>
	{
