...
pub struct PacketProcessingConfigurationForQinQVirtualLan
{
	...
	pub outer_packet_processing_configuration: PacketProcessingConfiguration,
...
impl PacketProcessingConfigurationForQinQVirtualLan
{
	...
	{
		self.outer_packet_processing_configuration.drop_packets_of_class_of_service(outer_class_of_service) || self.inner_packet_processing_configuration.drop_packets_of_class_of_service(inner_class_of_service)
	}
}
