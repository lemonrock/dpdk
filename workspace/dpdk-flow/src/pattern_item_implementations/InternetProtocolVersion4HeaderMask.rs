...
#[repr(C, packed)]
pub struct InternetProtocolVersion4HeaderMask
{
...
impl MaskedPacketMatcher for InternetProtocolVersion4HeaderMask
{
	type Type = rte_flow_item_ipv4;
}

impl Mask for InternetProtocolVersion4HeaderMask
{
	#[inline(always)]
