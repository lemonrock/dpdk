...
/// Mask for an `PacketMatcher::InternetControlMessageProtocolVersion6NeighborDiscoveryAdvertisement`.
#[derive(Debug)]
#[derive(Serialize)]
...
impl MaskedPacketMatcher for InternetControlMessageProtocolVersion6NeighborDiscoveryAdvertisementMask
{
