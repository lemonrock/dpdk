...
/// Specification for an `PacketMatcher::InternetControlMessageProtocolVersion6NeighborDiscoverySolicitation`.
#[derive(Debug)]
#[derive(Serialize)]
...
impl MaskedPacketMatcher for InternetControlMessageProtocolVersion6NeighborDiscoverySolicitationSpecification
{
