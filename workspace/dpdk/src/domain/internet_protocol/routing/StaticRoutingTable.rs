...
{
	longest_prefix_match: IpLookupTable<NetworkAddress::HostAddress::RustAddress>,
	default_route_to_next_hop: EthernetDestination,
}

impl<HostAddress: InternetProtocolHostAddress> StaticRoutingTable<HostAddress>
{
	/// Finds the information necessary to send to this address.
	#[inline(always)]
	pub fn route_to_next_hop(&self, destination_internet_protocol_host_address: &HostAddress) -> EthernetDestination
	{
