...
pub struct KasumiCryptoVirtualDevice
{
	index: u5,
...
impl VirtualDevice for KasumiCryptoVirtualDevice
{
	type V = CryptoVirtualDeviceDriverName;
	
	const DriverName: CryptoVirtualDeviceDriverName = CryptoVirtualDeviceDriverName::Kasumi;
...
impl CryptoVirtualDevice for KasumiCryptoVirtualDevice
{
	#[inline(always)]
...
impl KasumiCryptoVirtualDevice
{
	#[inline(always)]
