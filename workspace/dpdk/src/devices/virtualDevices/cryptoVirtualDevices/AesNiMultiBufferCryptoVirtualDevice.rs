...
pub struct AesNiMultiBufferCryptoVirtualDevice
{
	index: u5,
...
impl VirtualDevice for AesNiMultiBufferCryptoVirtualDevice
{
	type V = CryptoVirtualDeviceDriverName;
	
	const DriverName: CryptoVirtualDeviceDriverName = CryptoVirtualDeviceDriverName::AesNiMultiBuffer;
...
impl CryptoVirtualDevice for AesNiMultiBufferCryptoVirtualDevice
{
	#[inline(always)]
...
impl AesNiMultiBufferCryptoVirtualDevice
{
	#[inline(always)]
	...
	pub fn new(index: u5, numaSocketId: NumaSocketId, maximNumberOfQueuePairs: u31, maximNumberOfSessions: u31) -> Self
	{
		...
		AesNiMultiBufferCryptoVirtualDevice
		{
			index: index,
