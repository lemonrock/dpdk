...
impl DpdkPciDeviceAddress
{
	...
	///
	/// A device number is effectively a slot number. Zero based.
	///
	/// A function is usually one less than the number of ethernet ports, connectors, etc on a device. Zero based.
	///
	/// Domain is a Linux-centric concept.
	#[inline(always)]
	pub fn new(domain: u16, bus: u8, device_number: u5, function: u4) -> Self
	{
