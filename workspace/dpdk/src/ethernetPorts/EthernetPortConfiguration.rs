...
impl EthernetPortConfiguration
{
	...
	fn configure(&self, portIdentifier: EthernetPortIdentifier, numberOfReceiveQueues: u16, numberOfTransmitQueues: u16) -> Result<(), i32>
	{
		...
		let ethernetInternalConfiguration = rte_eth_conf
		{
			...
			tx_adv_conf: self.transmitAdvancedConfiguration.as_eth_conf__bindgen_ty_2(),
		...
		match unsafe { rte_eth_dev_configure(portIdentifier, numberOfReceiveQueues, numberOfTransmitQueues, &ethernetInternalConfiguration) }
		{
			0 => Ok(()),
