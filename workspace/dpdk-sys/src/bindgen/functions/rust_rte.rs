...
extern "C"
{
	...
	pub fn rust_rte_ring_enqueue_bulk(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
	pub fn rust_rte_ring_enqueue_burst(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
	...
	pub fn rust_rte_ring_mp_enqueue_bulk(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
	pub fn rust_rte_ring_mp_enqueue_burst(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
	...
	pub fn rust_rte_ring_sp_enqueue_bulk(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
	pub fn rust_rte_ring_sp_enqueue_burst(r: *mut rte_ring, obj_table: *const *const c_void, n: c_uint, free_space: *mut c_uint) -> c_uint;
