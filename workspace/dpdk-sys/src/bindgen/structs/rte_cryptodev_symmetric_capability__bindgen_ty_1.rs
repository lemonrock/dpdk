...
impl Default for rte_cryptodev_symmetric_capability__bindgen_ty_1
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_cryptodev_symmetric_capability__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_cryptodev_symmetric_capability__bindgen_ty_1 {{ union }}")
	}
}
