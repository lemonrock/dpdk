...
impl Debug for rte_port_ring_reader_frag_params
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_port_ring_reader_frag_params {{ ring: {:?}, pool_direct: {:?}, pool_indirect: {:?} }}", self.ring, self.pool_direct, self.pool_indirect)
	}
}
