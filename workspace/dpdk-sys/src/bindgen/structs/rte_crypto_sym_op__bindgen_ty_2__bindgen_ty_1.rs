...
impl Default for rte_crypto_sym_op__bindgen_ty_2__bindgen_ty_1
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_crypto_sym_op__bindgen_ty_2__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_crypto_sym_op__bindgen_ty_2__bindgen_ty_1 {{ data: {:?}, digest: {:?}, aad: {:?} }}", self.data, self.digest, self.aad)
	}
}
