...
impl Default for rte_flow_action_phy_port
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_flow_action_phy_port
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_flow_action_phy_port {{ original : {:?}, reserved : {:?} }}", self.original(), self.reserved())
	}
}
