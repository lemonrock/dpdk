...
impl Default for rte_tm_node_capabilities__bindgen_ty_1__bindgen_ty_1
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_tm_node_capabilities__bindgen_ty_1__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_tm_node_capabilities__bindgen_ty_1__bindgen_ty_1 {{  }}")
	}
}
