...
impl Default for rte_flow_action_port_id
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_flow_action_port_id
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_flow_action_port_id {{ original : {:?}, reserved : {:?} }}", self.original(), self.reserved())
	}
}
