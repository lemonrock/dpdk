...
{
	pub inner_esp_next_proto: __BindgenUnionField<u8>,
...
impl Debug for rte_mbuf__bindgen_ty_3__bindgen_ty_1__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_mbuf__bindgen_ty_3__bindgen_ty_1__bindgen_ty_1 {{ union }}")
	}
}
