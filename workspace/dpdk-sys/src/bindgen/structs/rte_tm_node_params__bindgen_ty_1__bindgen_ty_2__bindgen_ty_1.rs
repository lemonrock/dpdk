...
impl Debug for rte_tm_node_params__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_tm_node_params__bindgen_ty_1__bindgen_ty_2__bindgen_ty_1 {{ shared_wred_context_id: {:?} }}", self.shared_wred_context_id)
	}
}
