...
#[repr(C)]
pub struct rte_tm_level_capabilities_1_1
{
...
impl Default for rte_tm_level_capabilities_1_1
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_tm_level_capabilities_1_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_tm_level_capabilities_1_1 {{  }}")
	}
}
