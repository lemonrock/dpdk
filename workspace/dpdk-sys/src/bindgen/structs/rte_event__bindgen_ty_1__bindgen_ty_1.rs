...
impl Default for rte_event__bindgen_ty_1__bindgen_ty_1
{
	#[inline(always)]
	fn default() -> Self
	{
...
impl Debug for rte_event__bindgen_ty_1__bindgen_ty_1
{
	#[inline(always)]
	fn fmt(&self, f: &mut Formatter) -> Result
	{
		write!(f, "rte_event__bindgen_ty_1__bindgen_ty_1 {{ flow_id : {:?}, sub_event_type : {:?}, event_type : {:?}, op : {:?}, rsvd : {:?}, sched_type : {:?} }}", self.flow_id(), self.sub_event_type(), self.event_type(), self.op(), self.rsvd(), self.sched_type())
	}
}
...
impl rte_event__bindgen_ty_1__bindgen_ty_1
{
	...
	{
		unsafe { transmute(self._bitfield_1.get(0usize, 20u8) as u32) }
	}
	...
	{
		unsafe { transmute(self._bitfield_1.get(20usize, 8u8) as u32) }
	}
	...
	{
		unsafe { transmute(self._bitfield_1.get(28usize, 4u8) as u32) }
	}
	...
	pub fn op(&self) -> u8
	{
		unsafe { transmute(self._bitfield_1.get(32usize, 2u8) as u8) }
	}
	...
	pub fn rsvd(&self) -> u8
	{
		unsafe { transmute(self._bitfield_1.get(34usize, 4u8) as u8) }
	}
	...
	{
		unsafe { transmute(self._bitfield_1.get(38usize, 2u8) as u8) }
	}
	...
	#[inline(always)]
	pub fn new_bitfield_1(flow_id: u32, sub_event_type: u32, event_type: u32, op: u8, rsvd: u8, sched_type: u8) -> __BindgenBitfieldUnit<[u8; 8usize], u32>
	{
